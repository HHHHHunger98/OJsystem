...
/**
 * Java language strategy based on judging context for Java language
 * So far, the context is the same as the default context,
 * todo specify the judge context for java language, for example, increase the time limit.
 */
